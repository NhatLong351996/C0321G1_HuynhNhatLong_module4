...
public class BlogController {
    ...
    public ModelAndView getList(@PageableDefault(value = 3) Pageable pageable,
        ...
        if (category.isPresent()) {
            blogs = blogServicce.findAllByCategory_CategoryOrderByDatePublicationDesc(category.get(),pageable);
